...
#SBATCH --output=/hpc/group/bio1/ewhisnant/armaleo-data/funannotate2/scripts/logs/f2_clagr3_hardmask_nolow.out
#SBATCH --error=/hpc/group/bio1/ewhisnant/armaleo-data/funannotate2/scripts/logs/f2_clagr3_hardmask_nolow.err
...
OUTPUT=/hpc/group/bio1/ewhisnant/armaleo-data/funannotate2/clagr3_f2/hardmask-nolow
