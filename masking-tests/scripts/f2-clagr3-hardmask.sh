...
#SBATCH --output=/hpc/group/bio1/ewhisnant/armaleo-data/funannotate2/scripts/logs/f2_clagr3_hardmask.out
#SBATCH --error=/hpc/group/bio1/ewhisnant/armaleo-data/funannotate2/scripts/logs/f2_clagr3_hardmask.err
...
MASKED_DIR=/hpc/group/bio1/ewhisnant/armaleo-data/funannotate2/clagr3_f2/masked-genomes/hardmask
CLEANED_ASSEMBLY=/hpc/group/bio1/ewhisnant/armaleo-data/funannotate2/clagr3_f2/cleaned-genomes/${BASENAME}_cleaned.fasta
REPEATMASKED_ASSEMBLY=${MASKED_DIR}/${BASENAME}_sorted.cleaned.hardmasked.fasta

OUTPUT=/hpc/group/bio1/ewhisnant/armaleo-data/funannotate2/clagr3_f2/hardmask
